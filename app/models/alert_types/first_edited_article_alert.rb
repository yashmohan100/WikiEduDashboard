...
class FirstEditedArticleAlert < Alert
  def main_subject
    "Your students have started making edits to live Wikipedia articles! — #{course.slug}"
  end
  ...
  def send_email
    ...
    FirstEditedArticleMailer.send_email(self)
